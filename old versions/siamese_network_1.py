...
# 全結合層の設定
WL_fc1 = W_fc1 # W_fc1 = weight_variable([512, 32]) # (4x4) * 32, max_pool_2x2 makes image size half
bL_fc1 = b_fc1 # b_fc1 = bias_variable([32])
hL_pool1_flat = tf.reshape(hL_pool3, [-1, 512]) # (4x4) * 32 (out_ch) = 512, max_pool_2x2 makes image size half
hL_fc1 = tf.nn.relu(tf.matmul(hL_pool1_flat, WL_fc1) + bL_fc1) # out_ch = 32
